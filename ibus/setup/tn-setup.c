...
static void
ibus_lanxang_tn_disconnected_cb (IBusBus* bus, gpointer user_data)
{
  exit(2);
}
...
main (int argc, char **argv)
{
  ...
  context = g_option_context_new ("- ibus lanxang Thai Noi setup component");
  ...
  gtk_window_set_default_icon_from_file (PKGDATADIR"/icons/ibus-lanxang-tn.svg",
                                         NULL);
  main_dlg = ibus_lanxang_tn_setup_dialog_new ();
